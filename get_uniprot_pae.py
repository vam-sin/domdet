...
The sequences of the PDB (based on ATOM lines) is then aligned with the uniprot sequence
and the trimmed and aligned PAE is then saved as a matrix which is (n_residues x n_residues) 
[where n_residues refers to n_residues in ATOM lines of the PDB file  
"""
