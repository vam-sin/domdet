...
class conbr_block(nn.Module):
    def __init__(self, in_layer, out_layer, kernel_size, stride=1, dilation=1):
        """
        Convolutional layer with batch normalization
        :param in_layer: int - number of features per residue
        :param out_layer: int, use 32 as default
...
class se_block(nn.Module):
    '''
    SE stands for squeeze and excitation
    '''
